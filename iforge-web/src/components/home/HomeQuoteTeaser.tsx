      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <div className="space-y-3 pt-2 text-sm text-[#262626]">
          ...
          <div className="lg:col-span-6 bg-[#FBFBFB] border border-neutral-200/90 rounded-3xl p-6 sm:p-8 shadow-sm">
            <div className="space-y-5">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-white border border-neutral-200 rounded-xl px-4 py-3 text-sm font-medium text-[#262626] focus:outline-none focus:border-[#E61E32] shadow-2xs"
                >
                  {servicesData.map((s) => (
              ...
              <div className="bg-white border border-neutral-200/90 rounded-2xl p-5 space-y-3">
                <div className="flex items-center justify-between text-xs pb-3 border-b border-neutral-100">
                  <span className="font-semibold text-neutral-500">Selected Practice:</span>
                  <span className="font-bold text-black">{serviceObj.title}</span>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-[11px] text-neutral-500 font-medium">Estimated Delivery</div>
                    <div className="text-base font-extrabold text-[#E61E32] mt-0.5">
                      {currentEst.duration}
                    </div>
                  </div>
                  <div>
                    <div className="text-[11px] text-neutral-500 font-medium">Recommended Squad</div>
              ...
              <Link
                ...
                className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl text-sm font-semibold text-white bg-[#E61E32] hover:bg-[#C81426] shadow-md shadow-[#E61E32]/25 transition-all hover:scale-[1.01]"
              >
