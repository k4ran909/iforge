...
export default function QuotePage() {
  return (
    <div className="w-full bg-neutral-50 min-h-[calc(100vh-140px)] py-12 lg:py-18">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        {/* Bottom Trust Row */}
        <div className="max-w-2xl mx-auto flex flex-wrap items-center justify-center gap-6 text-xs text-neutral-500 pt-4">
