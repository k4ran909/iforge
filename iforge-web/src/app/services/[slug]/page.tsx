...
const iconMap: Record<string, React.ReactNode> = {
  ...
  Server: <Server className="w-8 h-8 text-black" />,
...
export default async function ServicePage({ params }: Props) {
  ...
  return (
    <div className="w-full bg-white">
      {/* Service Hero Header */}
      <section className="relative overflow-hidden pt-10 pb-16 lg:pt-16 lg:pb-20 bg-gradient-to-b from-neutral-50 via-white to-white border-b border-neutral-100">
        <div 
          aria-hidden="true" 
          className="pointer-events-none absolute -top-40 right-1/4 w-[600px] h-[350px] bg-[#E61E32]/8 blur-3xl rounded-full" 
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-8 space-y-5">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3.5">
                ...
                <a
                  href="#consultation"
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-semibold text-black bg-white hover:bg-neutral-50 border border-neutral-200 transition-colors hover:border-[#E61E32]"
                >
            ...
            <div className="lg:col-span-4 bg-white border border-neutral-200 rounded-3xl p-6 sm:p-8 shadow-sm space-y-4">
              <div className="flex items-center gap-3 pb-3 border-b border-neutral-100">
                <div className="w-12 h-12 rounded-xl bg-[#FDE8EA] flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-sm font-bold text-black">{service.title} SLA</div>
                </div>
              </div>

              <div className="space-y-4 pt-1">
                {service.metrics.map((metric, mIdx) => (
                  <div key={mIdx} className="p-3.5 rounded-xl bg-neutral-50 border border-neutral-100">
                    <div className="text-2xl font-extrabold text-black">{metric.value}</div>
                    <div className="text-xs font-semibold text-neutral-600 mt-0.5">{metric.label}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {service.offerings.map((offering, idx) => (
              <div
                key={idx}
                className="bg-white border border-neutral-200 rounded-2xl p-6 sm:p-8 flex flex-col justify-between shadow-xs hover:border-[#E61E32] hover:shadow-lg transition-all"
              >
                <div>
                  <div className="w-10 h-10 rounded-xl bg-black text-white flex items-center justify-center font-bold text-sm mb-5">
                    0{idx + 1}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
            ...
            <div className="space-y-6">
              <div>
                ...
                <h3 className="text-2xl font-bold text-black mt-1">Guaranteed Technical Deliverables</h3>
              </div>
              <div className="space-y-3">
                {service.deliverables.map((del, dIdx) => (
                  <div key={dIdx} className="flex items-start gap-3 p-4 rounded-xl bg-white border border-neutral-200">
                    <CheckCircle2 className="w-5 h-5 text-emerald-600 shrink-0 mt-0.5" />
                    <span className="text-sm font-semibold text-neutral-800">{del}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <h3 className="text-2xl font-bold text-black mt-1">Certified Frameworks & Stacks</h3>
              </div>
              <div className="bg-white border border-neutral-200 rounded-2xl p-6 sm:p-8 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {service.technologies.map((tech, tIdx) => (
                    <span
                      key={tIdx}
                      className="px-3.5 py-1.5 rounded-lg bg-[#FDE8EA] border border-[#E61E32]/20 text-xs font-bold text-black"
                    >
                      {tech}
                    </span>
                  ))}
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
            ...
            <h2 className="text-3xl font-extrabold text-black">Measurable Enterprise Benefits</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {service.benefits.map((benefit, bIdx) => (
              <div
                key={bIdx}
                className="p-6 rounded-2xl bg-neutral-50 border border-neutral-200 hover:border-[#E61E32] transition-all"
              >
                <div className="w-10 h-10 rounded-xl bg-[#FDE8EA] flex items-center justify-center text-[#E61E32] mb-4">
                  <Zap className="w-5 h-5" />
                </div>
                <h4 className="text-sm font-bold text-black mb-2">Benefit 0{bIdx + 1}</h4>
                <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">{benefit}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-neutral-50 border-t border-neutral-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center space-y-2">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FDE8EA] text-black text-xs font-bold">
      ...
      <section id="consultation" className="py-16 lg:py-24 bg-white border-t border-neutral-200">
      ...
      <section className="py-16 bg-neutral-50 border-t border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h3 className="text-xl font-bold text-black">Related Practice Areas</h3>
              <p className="text-xs text-neutral-500">Explore complementary capabilities</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedServices.map((rel) => (
              <Link
                ...
                className="bg-white border border-neutral-200 rounded-2xl p-6 hover:border-[#E61E32] hover:shadow-md transition-all group"
              >
                <div className="w-10 h-10 rounded-xl bg-[#FDE8EA] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  {iconMap[rel.iconName] || <Server className="w-5 h-5 text-[#E61E32]" />}
                </div>
                <h4 className="text-base font-bold text-black group-hover:text-[#E61E32] transition-colors mb-1">
                  {rel.title}
                </h4>
